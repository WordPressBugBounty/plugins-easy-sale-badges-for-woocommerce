...
- **Add Quick View to the Shop Page with multiple themes support**
...
= 7.3.2 =
* Fixed a bug where the discount badge for related products on the single product page displayed an incorrect value when selecting a product variation.
...
= 7.3.1 =
* Added Archive Variable Discounts display option for variable products on archive/shop pages.
* Compatibility with WooCommerce 10.9.4
